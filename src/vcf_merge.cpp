 ...
 * @return outStruct
**/
MERGE::baseVcfStruct MERGE::build_basefile_index(
 ...
 * @return 0
**/
int MERGE::build_softwarefile_index(
    baseVcfStruct & mergeVcfStruct, 
    const string & vcfFileName, 
...
**/
tuple<int, int> MERGE::recall_push(
    baseVcfStruct & mergeVcfStruct, 
...
**/
tuple<int, vector<int> > MERGE::get_hap_len(
    const string & svType, 
    const string & refSeq, 
...
**/
map<string, map<int, string > > MERGE::vcf_merge_filter(
    baseVcfStruct & mergeVcfStruct, 
    const int & softwareNum, 
    const string & mode
)
...
**/
tuple<float, float, float> MERGE::cal_var_sd(const vector<float>& data)
{
