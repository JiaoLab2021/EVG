...
**/
RECALL::vcfStructure RECALL::build_index(
    string genotype_filename
)
{
...
**/
string RECALL::gramtools_convert(
    string evaluateFilename
)
{
    string informations;
...
**/
tuple<int, vector<int> > RECALL::get_hap_len(
    const string & svType, 
    const string & refSeq, 
